...
import kotlinx.android.synthetic.main.app_bar_electronics.*

class Electronics : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.electronics, menu)
        return true
    }
